...
const byte DUMP_CHANNEL = 0b00001111;  // Channel we can use when we need to send something but don't want it to have any effect

const byte MIDI_STATUS = 0b10000000;
const byte MIDI_DATA = 0b00000000;

const byte NOTE_ON = 0b10010000;  // 144
const byte NOTE_OFF = 0b10000000; // 128
